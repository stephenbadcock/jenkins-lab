...
User is on date selection page
    ...
    Wait Until Element Contains    //h1[@id='questionText']    When do you want to make your trip?    timeout=15s
...
User logs in with valid credentials
    ...
    Wait Until Page Contains    You are signed in as ${user_first_name}    timeout=15s
...
User selects rental period
    ...
    Wait Until Element Is Visible    //input[@id='start']    timeout=15s
    Wait Until Element Is Visible    //input[@id='end']    timeout=15s
    Wait Until Element Is Visible    //button[@id='continue']    timeout=15s
...
User selects car
    ...
    Wait Until Element Is Visible    //input[@value='${license_number}']/../input[@value='Book']    timeout=15s
...
User submits credit card info
    ...
    Wait Until Element Is Visible    //input[@id='cardNum']    timeout=15s
    Wait Until Element Is Visible    //input[@id='fullName']    timeout=15s
    Wait Until Element Is Visible    //select[@title='Month']    timeout=15s
    Wait Until Element Is Visible    //select[@title='Year']    timeout=15s
    Wait Until Element Is Visible    //input[@id='cvc']    timeout=15s
    Wait Until Element Is Visible    //button[@id='confirm']    timeout=15s
...
A confirmation of the booking is shown    
    ...
    Wait Until Page Contains    A ${car_model} is now ready for pickup ${pickup_date}    timeout=15s
...
An error message appears to the left of the buttons
    ...
    Wait Until Element Contains    //label[@id='signInError']    Wrong e-mail or password    timeout=15s
...
User cancels booking on 'My page'
    ...
    Wait Until Element Is Visible    xpath=//input[@value='${license_number}']/../button[text()='Cancel booking']    timeout=15s
...
A confirmation of the cancellation is shown
    ...
    Wait Until Element Is Visible    //button[@id='logout']    timeout=15s
    Wait Until Page Contains    Your car: ${license_number} has been Returned    timeout=15s
...
User filters cars by selected criteria
    ...
    Wait Until Element Is Visible    //div[@id='ms-list-1']//button    timeout=15s
    Wait Until Element Is Visible    //div[@id='ms-list-2']//button    timeout=15s
...
All available cars filtered by one criterion are shown
    ...
    Wait Until Page Contains Element    //div[@id='carSelection']    timeout=15s
